...
export default function FooterSection() {
  ...
  return (
    <footer id="footer" className="bg-[#0B0E14] text-slate-400 text-xs border-t border-slate-850 relative pt-[clamp(1.75rem,3vw,2.5rem)] pb-[clamp(1.25rem,2vw,1.75rem)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">

          {/* Main 3-Column Footer Content */}
          <div className="reveal-fade-up grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-10 pb-5 sm:pb-6">

            {/* Column 1: Company Logo & Identity Box */}
            <div className="md:col-span-5 space-y-3.5">
              {/* Logo / Brand Name */}
              <div className="flex items-center gap-2">
                <span className="font-extrabold text-base sm:text-lg lg:text-xl text-white tracking-tight">
                  DUDI Software
                </span>
              </div>

              {/* Slogan / Short description */}
              <p className="text-slate-300 text-[clamp(11px,0.85vw,12.5px)] leading-relaxed max-w-md font-normal">
              ...
              <div className="border-l-2 border-blue-500 pl-3.5 space-y-1 pt-0.5">
                ...
                <p className="text-[11px] sm:text-[11.5px] text-slate-400 font-medium">
            ...
            <div className="md:col-span-3">
              ...
              <div className="w-7 h-[2px] bg-red-500 rounded-full mb-3" />

              <ul className="space-y-1.5 sm:space-y-2 text-[clamp(11px,0.85vw,12px)]">
                <li>
            ...
            <div className="md:col-span-4">
              ...
              <div className="w-7 h-[2px] bg-blue-500 rounded-full mb-3" />

              <ul className="space-y-2.5 sm:space-y-3 text-[clamp(11px,0.85vw,12px)]">
                {/* Address 1 */}
                <li className="flex items-start gap-2.5">
                  <div className="w-6.5 h-6.5 sm:w-7 sm:h-7 rounded-full bg-slate-850 border border-slate-700/80 flex items-center justify-center shrink-0 mt-0.5 shadow-2xs">
                ...
                <li className="flex items-center gap-2.5">
                  <div className="w-6.5 h-6.5 sm:w-7 sm:h-7 rounded-full bg-slate-850 border border-slate-700/80 flex items-center justify-center shrink-0 shadow-2xs">
          ...
          <div className="pt-4 border-t border-slate-850/90 flex flex-col sm:flex-row items-center justify-between gap-3 text-slate-400 text-[11px] sm:text-[11.5px]">
            <div>
            ...
            <div>
              <a
                ...
                className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg border border-slate-800 bg-[#0F1420]/80 hover:bg-slate-800/90 hover:border-slate-700 text-slate-300 hover:text-white transition-all text-xs font-medium shadow-2xs group"
              >
                <Globe className="w-4 h-4 text-red-500 group-hover:scale-110 transition-transform duration-200" />
